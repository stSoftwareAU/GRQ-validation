...
class MockGRQValidator {
  ...
  getHistoricalToCurrentSplitAdjustment(stockSymbol: string, historicalDate: Date): number {
  ...
  adjustHistoricalPriceToCurrent(price: number, stockSymbol: string, historicalDate: Date): number {
  ...
  calculateStockPerformanceWithDilution(stock: Stock, scoreDate: Date): number | null {
